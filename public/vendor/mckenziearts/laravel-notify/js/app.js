    ...
    "+UWX": function (e, t) {
        ...
        (function (t) {
                    ...
                    matchGrammar: function (e, t, n, i, s, o, l) {
                        for (var c in n) if (n.hasOwnProperty(c) && n[c]) {
                            ...
                            for (var d = 0; d < u.length; ++d) {
                                if (l && l == c + "," + d) return;
                                var p = u[d], f = p.inside, g = !!p.lookbehind, m = !!p.greedy, h = 0, b = p.alias;
                                if (m && !p.pattern.global) {
                                    var v = p.pattern.toString().match(/[imsuy]*$/)[0];
                                    p.pattern = RegExp(p.pattern.source, v + "g")
                                }
                                p = p.pattern || p;
                                for (var y = i, k = s; y < t.length; k += t[y].length, ++y) {
                                    var S = t[y];
                                    if (t.length > e.length) return;
                                    if (!(S instanceof r)) {
                                        if (m && y != t.length - 1) {
                                            if (p.lastIndex = k, !(N = p.exec(e))) break;
                                            for (var w = N.index + (g && N[1] ? N[1].length : 0), x = N.index + N[0].length, A = y, j = k, L = t.length; A < L && (j < x || !t[A].type && !t[A - 1].greedy); ++A) (j += t[A].length) <= w && (++y, k = j);
                                            if (t[y] instanceof r) continue;
                                            P = A - y, S = e.slice(k, j), N.index -= k
                                        } else {
                                            p.lastIndex = 0;
                                            var N = p.exec(S), P = 1
                                        }
                                        if (N) {
                                            ...
                                            var C = S.slice(0, w), E = S.slice(x), T = [y, P];
                                            C && (++y, k += C.length, T.push(C));
                                            var O = new r(c, f ? a.tokenize(N, f) : N, b, N, m);
                                            if (T.push(O), E && T.push(E), Array.prototype.splice.apply(t, T), 1 != P && a.matchGrammar(e, t, n, y, k, !0, c + "," + d), o) break
                                        } else if (o) break
                                    }
                                }
                            }
            ...
            e.exports && (e.exports = n), void 0 !== t && (t.Prism = n), n.languages.markup = {
                ...
                var t = {pattern: /(\d)(?:%|[a-z]+)/, lookbehind: !0},
                    n = {pattern: /(^|[^\w.-])-?\d*\.?\d+/, lookbehind: !0};
                                ...
                                !function s(o) {
                                    for (var l = 0; l < o.length && !(r >= i.length); l++) {
                                        ...
                                        if ("string" == typeof c || c.content && "string" == typeof c.content) {
                                            var u = i[r], d = n.tokenStack[u], p = "string" == typeof c ? c : c.content,
                                                f = t(a, u), g = p.indexOf(f);
                                            if (-1 < g) {
                                                ++r;
                                                var m = p.substring(0, g),
                                                    h = new e.Token(a, e.tokenize(d, n.grammar), "language-" + a, d),
                                                    b = p.substring(g + f.length), v = [];
                                                m && v.push.apply(v, s([m])), v.push(h), b && v.push.apply(v, s([b])), "string" == typeof c ? o.splice.apply(o, [l, 1].concat(v)) : c.content = v
                                            }
                ...
                if ("undefined" != typeof self && self.Prism && self.document && document.querySelector) {
                    ...
                    n.hooks.add("before-sanity-check", (function (e) {
                        ...
                        var r = t.element.parentNode, s = r && r.getAttribute("data-line");
                        if (r && s && /pre/i.test(r.nodeName)) {
                            clearTimeout(a);
                            var c = n.plugins.lineNumbers, u = t.plugins && t.plugins.lineNumbers;
                ...
                function o(e, a, r) {
                    var o = (a = "string" == typeof a ? a : e.getAttribute("data-line")).replace(/\s+/g, "").split(","),
                        ...
                        c = (t() ? parseInt : parseFloat)(getComputedStyle(e).lineHeight), u = i(e, "line-numbers"),
                        d = u ? e : e.querySelector("code") || e, p = [];
                    return o.forEach((function (t) {
                        var a = t.split("-"), i = +a[0], s = +a[1] || i,
                        ...
                        if (p.push((function () {
                            ...
                            var f = n.plugins.lineNumbers.getLine(e, i), g = n.plugins.lineNumbers.getLine(e, s);
                            if (f) {
                ...
                function l() {
                    ...
                    if (t && !document.getElementById(e)) {
                        var n = e.slice(0, e.lastIndexOf(".")), a = document.getElementById(n);
                    ...
                    n.plugins.autolinker = {
                        processGrammar: function (t) {
                            t && !t["url-link"] && (n.languages.DFS(t, (function (t, s, o) {
                                -1 < i.indexOf(o) && !Array.isArray(s) && (s.pattern || (s = this[t] = {pattern: s}), s.inside = s.inside || {}, "comment" == o && (s.inside["md-link"] = r), "attr-value" == o ? n.languages.insertBefore("inside", "punctuation", {"url-link": e}, s) : s.inside["url-link"] = e, s.inside["email-link"] = a)
                    ...
                    n.plugins.dataURIHighlight = {
                        processGrammar: function (t) {
                            t && !t["data-uri"] && (n.languages.DFS(t, (function (t, r, i) {
                                -1 < a.indexOf(i) && !Array.isArray(r) && (r.pattern || (r = this[t] = {pattern: r}), r.inside = r.inside || {}, "attr-value" == i ? n.languages.insertBefore("inside", r.inside["url-link"] ? "url-link" : "punctuation", {"data-uri": e}, r) : r.inside["url-link"] ? n.languages.insertBefore("inside", "url-link", {"data-uri": e}, r) : r.inside["data-uri"] = e)
                            })), t["data-uri"] = e)
                        }
                    }, n.hooks.add("before-highlight", (function (t) {
                        if (e.pattern.test(t.code)) for (var a in e.inside) if (e.inside.hasOwnProperty(a) && !e.inside[a].inside && e.inside[a].pattern.test(t.code)) {
                            var r = a.match(/^language-(.+)/)[1];
                            n.languages[r] && (e.inside[a].inside = {rest: (i = n.languages[r], n.plugins.autolinker && n.plugins.autolinker.processGrammar(i), i)})
                        }
                        var i;
                ...
                if ("undefined" != typeof self && self.Prism && self.document && document.createElement) {
                    var e = {
                        ...
                        xeoracube: "xeora",
                        yml: "yaml"
                    }, a = {}, r = "components/", i = n.util.currentScript();
                    if (i) {
                        var s = /\bplugins\/autoloader\/prism-autoloader\.(?:min\.)js$/i, o = /[\w-]+\.(?:min\.)js$/i;
                        if (i.hasAttribute("data-autoloader-path")) r = i.getAttribute("data-autoloader-path").trim().replace(/\/?$/, "/"); else {
                            var l = i.src;
                            s.test(l) ? r = l.replace(s, "components/") : o.test(l) && (r = l.replace(o, "components/"))
                        }
                    }
                    var c = n.plugins.autoloader = {languages_path: r, use_minified: !0, loadLanguages: u};
                    n.hooks.add("complete", (function (e) {
                        e.element && e.language && !e.grammar && "none" !== e.language && function (e, a) {
                            e in t && (e = t[e]);
                            var r = a.getAttribute("data-dependencies"), i = a.parentElement;
                ...
                function d(r, i, s) {
                    ...
                    var l = function () {
                        var e = a[r];
                        e || (e = a[r] = {callbacks: []}), e.callbacks.push({
                            success: i,
                            error: s
                ...
                if ("undefined" != typeof self && self.Prism && self.document) {
                    ...
                    n.hooks.add("before-highlight", (function (t) {
                        var n = t.vars = t.vars || {}, a = n["command-line"] = n["command-line"] || {};
                        if (!a.complete && t.code) {
                            var r = t.element.parentNode;
                            if (r && /pre/i.test(r.nodeName) && (e.test(r.className) || e.test(t.element.className))) if (t.element.querySelector(".command-line-prompt")) a.complete = !0; else {
                                var i = t.code.split("\n");
                                a.numberOfLines = i.length;
                                var s = a.outputLines = [], o = r.getAttribute("data-output"),
                                    l = r.getAttribute("data-filter-output");
                                if (o || "" === o) {
                                    o = o.split(",");
                                    for (var c = 0; c < o.length; c++) {
                                        var u = o[c].split("-"), d = parseInt(u[0], 10),
                                ...
                                } else if (l) for (c = 0; c < i.length; c++) 0 === i[c].indexOf(l) && (s[c] = i[c].slice(l.length), i[c] = "");
                                t.code = i.join("\n")
                            } else a.complete = !0
                        } else a.complete = !0
                    })), n.hooks.add("before-insert", (function (e) {
                        var t = e.vars = e.vars || {}, n = t["command-line"] = t["command-line"] || {};
                        if (!n.complete) {
                        ...
                        if (!a.complete) {
                            ...
                            }, s = new Array((a.numberOfLines || 0) + 1), o = i("data-prompt", "");
                            if ("" !== o) s = s.join('<span data-prompt="' + o + '"></span>'); else {
                                var l = i("data-user", "user"), c = i("data-host", "localhost");
                                s = s.join('<span data-user="' + l + '" data-host="' + c + '"></span>')
                            }
                            var u = document.createElement("span");
                            u.className = "command-line-prompt", u.innerHTML = s;
                            for (var d = 0, p = (a.outputLines || []).length; d < p; d++) if (a.outputLines.hasOwnProperty(d)) {
                                var f = u.children[d];
                ...
                a.prototype = {
                    ...
                    if (!e.settings || !1 !== e.settings["whitespace-normalization"]) if (e.element && e.element.parentNode || !e.code) {
                        var a = e.element.parentNode, r = /(?:^|\s)no-whitespace-normalization(?:\s|$)/;
                ...
                if ("undefined" != typeof self && self.Prism && self.document) if (n.plugins.toolbar) {
                    var e = {
                        html: "HTML",
                        xml: "XML",
                        svg: "SVG",
                    ...
                    n.plugins.toolbar.registerButton("show-language", (function (t) {
                        ...
                        if (n && /pre/i.test(n.nodeName)) {
                            var a,
                                r = n.getAttribute("data-language") || e[t.language] || ((a = t.language) ? (a.substring(0, 1).toUpperCase() + a.substring(1)).replace(/s(?=cript)/, "S") : a);
                            if (r) {
                ...
                if ("undefined" != typeof self && self.Prism && self.document) {
                    var e = /(?:^|\s)match-braces(?:\s|$)/, t = /(?:^|\s)brace-hover(?:\s|$)/,
                        a = /(?:^|\s)brace-selected(?:\s|$)/, r = /(?:^|\s)no-brace-hover(?:\s|$)/,
                        i = /(?:^|\s)no-brace-select(?:\s|$)/, s = {"(": ")", "[": "]", "{": "}"},
                        o = {"(": "brace-round", "[": "brace-square", "{": "brace-curly"}, l = 0,
                        c = /^(pair-\d+-)(open|close)$/;
                    n.hooks.add("complete", (function (t) {
                        var n = t.element, r = n.parentElement;
                        if (r && "PRE" == r.tagName) {
                            for (var i = [], c = n; c; c = c.parentElement) if (e.test(c.className)) {
                                i.push("(", "[", "{");
                                break
                            }
                            if (0 != i.length) {
                                ...
                                })), Object.defineProperty(r, "__listenerAdded", {value: !0}));
                ...
                function d() {
                    for (var e = this.parentElement; e; e = e.parentElement) if (r.test(e.className)) return;
                ...
                function f() {
                    for (var e = this.parentElement; e; e = e.parentElement) if (i.test(e.className)) return;
                    [this, u(this)].forEach((function (e) {
