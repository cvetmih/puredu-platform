...
var handleTabsNavClick = function handleTabsNavClick(e) {
  ...
  var parent = e.target.closest('[data-tabs]');
  parent.querySelectorAll('[data-tab]').forEach(function (tab) {
  ...
  var navButtons = parent.querySelectorAll('[data-tabs-nav]').forEach(function (navButton) {
