        ...
        e.exports = function () {
            ...
            function c(e, t) {
                return Array.from(e.attributes).filter(l).map(e => {
                    const t = u(e.name), n = t.match(a), i = t.match(/:([a-zA-Z\-:]+)/),
                        r = t.match(/\.[^.\]]+(?=[^\]]*$)/g) || [];
                    return {
                        type: n ? n[1] : null,
                        value: i ? i[1] : null,
            ...
            function d(e, t, n = !1) {
                ...
                if (r && r.modifiers.includes("transition")) {
                    ...
                    const i = (t.find(e => "enter" === e.value) || {expression: ""}).expression.split(" ").filter(e => "" !== e),
                        ...
                        s = (t.find(e => "enter-end" === e.value) || {expression: ""}).expression.split(" ").filter(e => "" !== e);
                    h(e, i, r, s, n, () => {
                    })
                }(e, i, t) : t()
            }
            ...
            function f(e, t, n = !1) {
                ...
                if (r && r.modifiers.includes("transition")) {
                    ...
                    const i = n.includes("in") && n.includes("out");
                    n = i ? n.filter((e, t) => t > n.indexOf("out")) : n, function (e, t, n, i) {
                        const r = {
                            duration: n ? p(t, "duration", 150) : p(t, "duration", 150) / 2,
                            origin: p(t, "origin", "center"),
                            first: {opacity: 1, scale: 100},
                            second: {opacity: 0, scale: p(t, "scale", 95)}
                        };
                        m(e, t, () => {
                        }, i, r)
                    }(e, n, i, t)
                    ...
                    const i = (t.find(e => "leave" === e.value) || {expression: ""}).expression.split(" ").filter(e => "" !== e),
                        ...
                        s = (t.find(e => "leave-end" === e.value) || {expression: ""}).expression.split(" ").filter(e => "" !== e);
                    h(e, i, r, s, () => {
                    }, n)
                }(e, i, t) : t()
            }
            ...
            function m(e, t, n, i, r) {
                const s = e.style.opacity, o = e.style.transform, a = e.style.transformOrigin,
                    l = !t.includes("opacity") && !t.includes("scale"), c = l || t.includes("opacity"),
                    u = l || t.includes("scale"), d = {
                        start() {
                            ...
                            c && (e.style.opacity = s), u && (e.style.transform = o), u && (e.style.transformOrigin = a), e.style.transitionProperty = null, e.style.transitionDuration = null, e.style.transitionTimingFunction = null
                        }
                    };
                v(e, d)
            }
            ...
            function h(e, t, n, i, r, s) {
                const o = e.__x_original_classes || [], a = {
                    start() {
                        e.classList.add(...n)
                    }, during() {
                        e.classList.add(...t)
                        ...
                        e.classList.remove(...n.filter(e => !o.includes(e))), e.classList.add(...i)
                    }, hide() {
                        s()
                    }, cleanup() {
                        e.classList.remove(...t.filter(e => !o.includes(e))), e.classList.remove(...i.filter(e => !o.includes(e)))
                    }
                };
                v(e, a)
            }
            ...
            function y(e, t, i, r, s) {
                ...
                a.forEach((i, u) => {
                    ...
                    }(l.nextElementSibling, p);
                    m ? (delete m.__x_for_key, m.__x_for = f, e.updateElements(m, () => m.__x_for)) : (m = function (e, t) {
                        let n = document.importNode(e.content, !0);
                        return 1 !== n.childElementCount && console.warn("Alpine: <template> tag with [x-for] encountered with multiple element roots. Make sure <template> only has a single child node."), t.parentElement.insertBefore(n, t.nextElementSibling), t.nextElementSibling
                    }(t, l), d(m, () => {
                    }, r), m.__x_for = f, e.initializeElements(m, () => m.__x_for)), l = m, l.__x_for_key = p
                }), function (e) {
                    for (var t = !(!e.nextElementSibling || void 0 === e.nextElementSibling.__x_for_key) && e.nextElementSibling; t;) {
                        let e = t, n = t.nextElementSibling;
                        f(t, () => {
                            e.remove()
            ...
            function g(e, t, n, r, s, o) {
                var a = e.evaluateReturnExpression(t, r, s);
                if ("value" === n) if (void 0 === a && r.match(/\./).length && (a = ""), "radio" === t.type) void 0 === t.attributes.value && "bind" === o ? t.value = a : "bind" !== o && (t.checked = t.value == a); else if ("checkbox" === t.type) {
                    if (Array.isArray(a)) {
                        let e = !1;
                        a.forEach(n => {
                            n == t.value && (e = !0)
                    ...
                    if (t.value === a) return;
                    t.value = a
                } else if ("class" === n) if (Array.isArray(a)) {
                    const e = t.__x_original_classes || [];
                    t.setAttribute("class", i(e.concat(a)).join(" "))
                } else if ("object" == typeof a) Object.keys(a).sort((e, t) => a[e] - a[t]).forEach(e => {
                    a[e] ? e.split(" ").filter(Boolean).forEach(e => t.classList.add(e)) : e.split(" ").filter(Boolean).forEach(e => t.classList.remove(e))
                }); else {
                    const e = t.__x_original_classes || [], n = a.split(" ").filter(Boolean);
                    t.setAttribute("class", i(e.concat(n)).join(" "))
                } else [null, void 0, !1].includes(a) ? t.removeAttribute(n) : function (e) {
                    return ["disabled", "checked", "required", "readonly", "hidden", "open", "selected", "autofocus", "itemscope", "multiple", "novalidate", "allowfullscreen", "allowpaymentrequest", "formnovalidate", "autoplay", "controls", "loop", "muted", "playsinline", "default", "ismap", "reversed", "async", "defer", "nomodule"].includes(e)
                }(n) ? t.setAttribute(n, n) : t.setAttribute(n, a)
            }

            function x(e, t, n, i, r, o = {}) {
                if (i.includes("away")) {
                    let s = a => {
                        t.contains(a.target) || t.offsetWidth < 1 && t.offsetHeight < 1 || (w(e, r, a, o), i.includes("once") && document.removeEventListener(n, s))
                    };
                    document.addEventListener(n, s)
                } else {
                    let a = i.includes("window") ? window : i.includes("document") ? document : t, l = s => {
                        a !== window && a !== document || document.body.contains(t) ? function (e) {
                            ...
                            return n = n.filter(e => !i.includes(e)), !(i.length > 0 && i.filter(t => ("cmd" !== t && "super" !== t || (t = "meta"), e[t + "Key"])).length === i.length && n[0] === _(e.key))
                        }(s, i) || (i.includes("prevent") && s.preventDefault(), i.includes("stop") && s.stopPropagation(), i.includes("self") && s.target !== t) || (!1 === w(e, r, s, o) ? s.preventDefault() : i.includes("once") && a.removeEventListener(n, l)) : a.removeEventListener(n, l)
                    };
            ...
            function E(e, t, n) {
                return "radio" === e.type && (e.hasAttribute("name") || e.setAttribute("name", n)), (n, i) => {
                    ...
                    if ("select" === e.tagName.toLowerCase() && e.multiple) return t.includes("number") ? Array.from(n.target.selectedOptions).map(e => {
                        const t = e.value || e.text, n = t ? parseFloat(t) : null;
                        return isNaN(n) ? t : n
                    }) : Array.from(n.target.selectedOptions).map(e => e.value || e.text);
                    {
                        const e = n.target.value, i = e ? parseFloat(e) : null;
            ...
            const {isArray: O} = Array, {
                ...
                preventExtensions: T,
                hasOwnProperty: N
            } = Object, {push: L, concat: R, map: z} = Array.prototype;
            ...
            function W(e, t, n) {
                R.call(D(n), C(n)).forEach(i => {
                    let r = j(n, i);
                    r.configurable || (r = ee(e, r, U)), A(t, i, r)
                }), T(t)
            }
            ...
            class K {
                ...
                get(e, t) {
                    const {originalTarget: n, membrane: i} = this, r = n[t], {valueObserved: s} = i;
                ...
                ownKeys(e) {
                    ...
                    return R.call(D(t), C(t))
                }

                isExtensible(e) {
                    const t = $(e);
                    if (!t) return t;
                    const {originalTarget: n, membrane: i} = this, r = $(n);
                    return r || W(i, e, n), r
                }
                ...
                getOwnPropertyDescriptor(e, t) {
                    ...
                    if (M(s)) return s;
                    const o = j(e, t);
                    return M(o) ? (s = ee(i, s, U), s.configurable || A(e, t, s), s) : o
                }
                ...
                defineProperty(e, t, n) {
                    ...
                    return A(i, t, function (e) {
                        return N.call(e, "value") && (e.value = B(e.value)), e
                    }(n)), !1 === o && A(e, t, ee(r, n, U)), s(i, t), !0
                }
            }
            ...
            class H {
                ...
                get(e, t) {
                    const {membrane: n, originalTarget: i} = this, r = i[t], {valueObserved: s} = n;
                ...
                getOwnPropertyDescriptor(e, t) {
                    ...
                    if (M(s)) return s;
                    const o = j(e, t);
                    return M(o) ? (s = ee(i, s, G), N.call(s, "set") && (s.set = void 0), s.configurable || A(e, t, s), s) : o
                }
            ...
            function ee(e, t, n) {
                const {set: i, get: r} = t;
                return N.call(t, "value") ? t.value = n(e, t.value) : (M(r) || (t.get = function () {
                    return n(e, r.call(B(this)))
                }), M(i) || (t.set = function (t) {
                    i.call(B(this), e.unwrapProxy(t))
                })), t
            }

            class te {
                constructor(e) {
                    if (this.valueDistortion = Y, this.valueMutated = X, this.valueObserved = V, this.valueIsObservable = Q, this.objectGraph = new WeakMap, !M(e)) {
                        const {valueDistortion: t, valueMutated: n, valueObserved: i, valueIsObservable: r} = e;
                        this.valueDistortion = F(t) ? t : Y, this.valueMutated = F(n) ? n : X, this.valueObserved = F(i) ? i : V, this.valueIsObservable = F(r) ? r : Q
                    }
                }

                getProxy(e) {
                    const t = B(e), n = this.valueDistortion(t);
                ...
                getReactiveState(e, t) {
                    ...
                    return i = {
                        get reactive() {
                            const n = new K(r, t), i = new Proxy(Z(t), n);
                            return q(i, e), A(this, "reactive", {value: i}), i
                        }, get readOnly() {
                            const n = new H(r, t), i = new Proxy(Z(t), n);
                            return q(i, e), A(this, "readOnly", {value: i}), i
                        }
                    }, n.set(t, i), i
                }
            }
            ...
            class ne {
                constructor(e, t = null) {
                    this.$el = e;
                    const n = this.$el.getAttribute("x-data"), i = "" === n ? "{}" : n,
                        r = this.$el.getAttribute("x-init");
                    this.unobservedData = t || o(i, {});
                    let {membrane: s, data: a} = this.wrapDataInObservable(this.unobservedData);
                    var l;
                    this.$data = a, this.membrane = s, this.unobservedData.$el = this.$el, this.unobservedData.$refs = this.getRefsProxy(), this.nextTickStack = [], this.unobservedData.$nextTick = e => {
                ...
                registerListeners(e, t) {
                    c(e).forEach(({type: i, value: r, modifiers: s, expression: o}) => {
                        switch (i) {
                            case"on":
                                x(this, e, r, s, o, t);
                                break;
                            case"model":
                                !function (e, t, i, r, s) {
                                    ...
                                    x(e, t, o, i, `${r} = rightSideOfExpression($event, ${r})`, () => n({}, s(), {rightSideOfExpression: E(t, i, r)}))
                                }(this, e, s, o, t)
                        }
                    })
                }
                    ...
                    i.forEach(({type: r, value: s, modifiers: o, expression: a}) => {
                        switch (r) {
                            ...
                            case"html":
                                ...
                                break;
                            case"show":
                                l = this.evaluateReturnExpression(e, a, n), function (e, t, n, i, r = !1) {
                                    const s = () => {
                            ...
                            case"if":
                                ...
                                l = this.evaluateReturnExpression(e, a, n), function (e, t, n, i, r) {
                                    ...
                                    if (n && !s) {
                                        ...
                                        t.parentElement.insertBefore(n, t.nextElementSibling), d(t.nextElementSibling, () => {
                                        }, i), e.initializeElements(t.nextElementSibling, r), t.nextElementSibling.__x_inserted_me = !0
                ...
                evaluateReturnExpression(e, t, i = (() => {
                    ...
                    return o(t, this.$data, n({}, i(), {$dispatch: this.getDispatchFunction(e)}))
                }
            ...
            const ie = {
                version: "2.3.5", start: async function () {
